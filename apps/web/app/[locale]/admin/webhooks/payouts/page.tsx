...
import AdminPayoutWebhookTable from "@/app/[locale]/admin/webhooks/payouts/AdminPayoutWebhookTable";

export default async function AdminPayoutWebhookPage({
  params,
}: {
  ...
  return (
    <div className="mx-auto w-full max-w-6xl px-6 py-16 lg:px-8 lg:py-24">
      ...
      <h1 className="mt-2 text-3xl font-semibold text-slate-900">
        {messages.adminPayoutWebhookTitle}
      </h1>
      <p className="mt-2 text-sm text-slate-600">
        {messages.adminPayoutWebhookSubtitle}
      </p>
      <AdminPayoutWebhookTable locale={validLocale} messages={messages} />
    </div>
  );
}
